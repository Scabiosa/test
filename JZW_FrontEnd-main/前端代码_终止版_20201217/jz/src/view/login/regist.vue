      ...
      <div v-show="showForm" class="form">
        <el-form class="login-container"
          ...
          <el-form-item :label="$t('user.password')" prop="password">
            <el-input v-model="account.password" type="password" :placeholder="$t('user.password')"></el-input>
          </el-form-item>

          <!-- 重复密码 -->
          <el-form-item :label="$t('user.repeatpassword')" prop="repeatPassword">
            <el-input v-model="account.repeatPassword" type="password" :placeholder="$t('user.repeatpassword')"></el-input>
          </el-form-item>

          <!-- 企业税号 -->
          <el-form-item :label="$t('user.comcode')" prop="code" v-if="showComCodeInput">
            <el-input v-model="account.code" type="text" :placeholder="$t('user.comcode')"></el-input>
          </el-form-item>

          <!-- 政府机构号 -->
          <el-form-item :label="$t('user.govcode')" prop="code" v-if="showGovCodeInput">
            <el-input v-model="account.code" type="text" :placeholder="$t('user.govcode')"></el-input>
          </el-form-item>
